...
- [状态压缩：对动态规划进行降维打击](https://labuladong.gitbook.io/algo/dong-tai-gui-hua-xi-lie/1.1-dong-tai-gui-hua-ji-ben-ji-qiao/zhuang-tai-ya-suo-ji-qiao)
...
![img](..\pictures\反转链表\2.jpg)

这个 `reverse(head.next)` 执行完成后，整个链表就成了这样：

![img](..\pictures\反转链表\3.jpg)
